...
namespace Mirror
{
    public static class ClientScene
    {
        ...
        {
            if (LogFilter.Debug) Debug.LogWarning("ClientScene.InternalAddPlayer:"+ identity.gameObject.name);
        ...
        public static bool AddPlayer(NetworkConnection readyConn, byte[] extraData)
        {
            ...
            if (LogFilter.logDebug) Debug.Log("ClientScene.AddPlayer() called with connection [" + readyConnection + "]");
        ...
        internal static void OnSpawnPrefab(NetworkConnection conn, SpawnPrefabMessage msg)
        {
            ...
            //if (LogFilter.logDebug) Debug.Log("Client spawn handler instantiating [netId:" + msg.netId + " asset ID:" + msg.assetId + " pos:" + msg.position + "]"+ conn.playerController.gameObject.name);
