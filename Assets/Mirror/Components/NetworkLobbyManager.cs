...
namespace Mirror
{
    ...
    public class NetworkLobbyManager : NetworkManager
    {
        ...
        {
            if (LogFilter.logDebug) Debug.LogFormat("NetworkLobby SceneLoadedForPlayer scene: {0} {1}", SceneManager.GetActiveScene().name, conn);
            ...
            if (gamePlayer == null)
            {
                ...
                Debug.Log("NetworkLobby SceneLoadedForPlayer でgamePlayerが生成しました:"+ gamePlayer.name);
            }
            else
            {
